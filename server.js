...
async function sendOTP(email, otp, type) {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 500px; padding: 20px; background: #0a0515; color: white; border-radius: 16px; border: 1px solid rgba(139,92,246,0.2);">
